...
export class StreamEvent {
  ...
  content?: string | null | undefined; // 文本内容
  tool_name?: string | null | undefined; // 工具名称
  tool_args?: Record<string, any> | null | undefined; // 工具参数
  tool_call_id?: string | null | undefined; // 工具调用ID
  metadata?: Record<string, any> | null | undefined; // 其他元数据
